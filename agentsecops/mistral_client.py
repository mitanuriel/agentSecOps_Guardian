...
from .promptregistry import get_prompt
...
class MistralClient:
    ...
    def analyze_with_mistral(self, text: str, analysis_type: str = "security_analysis", 
                             security_findings: Optional[Dict] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if 'choices' in result and len(result['choices']) > 0:
                ...
                return {
                    "error": "No valid response from Mistral API",
                    "full_api_response": result
                }
    ...
    def get_secure_coding_recommendations(self, text: str, security_findings: Dict[str, Any]) -> Dict[str, Any]:
...
def analyze_with_mistral_api(text: str, api_key: Optional[str] = None, 
